...
type Filter interface {
	...
	updateMask(blk *columnBasedBlock, mask []bool)
}
...
func (filter *IntRangeFilter) updateMask(blk *columnBasedBlock, mask []bool) {
...
func (filter *IntValueFilter) updateMask(blk *columnBasedBlock, mask []bool) {
	column := blk.intColumns[filter.Index]
	for i, elem := range column {
...
func (filter *BlobValueFilter) updateMask(blk *columnBasedBlock, mask []bool) {
